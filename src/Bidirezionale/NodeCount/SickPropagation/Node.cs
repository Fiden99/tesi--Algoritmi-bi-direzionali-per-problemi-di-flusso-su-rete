...
namespace Bidirezionale.NodeCount.SickPropagation
{
    ...
    public class Node
    {
        ...
        public bool SinkValid { get; private set; }
        ...
        public void SetSourceValid(bool valid) => this.SourceValid = valid;
        public void SetSinkValid(bool valid) => this.SinkValid = valid;
    }
}
